    ...
    methods: [
      {
        ...
        type: "subscription",
        signature:
          "connectionStatusSubscribe(): ObservableLike<HostAccountConnectionStatusSubscribeItem, S.CallErrorValue<VersionedHostAccountConnectionStatusSubscribeError>>",
        docUrl:
      ...
      },
      {
        ...
        type: "unary",
        signature:
          "getAccountAlias(request: HostAccountGetAliasRequest): Promise<Result<ContextualAlias, S.CallErrorValue<VersionedHostAccountGetAliasError>>>",
      ...
      },
      {
        ...
        type: "unary",
        signature:
          "signVrf(request: HostAccountSignVrfRequest): Promise<Result<VrfSignature, S.CallErrorValue<VersionedHostAccountSignVrfError>>>",
      ...
      },
      {
        ...
        type: "unary",
        signature:
          "registerRingVrfKey(request: HostAccountRegisterRingVrfKeyRequest): Promise<Result<RingVrfPublicKey, S.CallErrorValue<VersionedHostAccountRegisterRingVrfKeyError>>>",
      ...
      },
      {
        ...
        type: "unary",
        signature:
          "listRingVrfKeys(request: HostAccountListRingVrfKeysRequest): Promise<Result<Array<RegisteredRingVrfKey>, S.CallErrorValue<VersionedHostAccountListRingVrfKeysError>>>",
      ...
      },
      {
        ...
        type: "unary",
        signature:
          "ringVrfSign(request: HostAccountRingVrfSignRequest): Promise<Result<HexString, S.CallErrorValue<VersionedHostAccountRingVrfSignError>>>",
    ...
    methods: [
      {
        ...
        type: "subscription",
        signature:
          "followHeadSubscribe(request: RemoteChainHeadFollowRequest): ObservableLike<RemoteChainHeadFollowItem, S.CallErrorValue<VersionedRemoteChainHeadFollowError>>",
      ...
      },
      {
        ...
        type: "unary",
        signature:
          "getChainInfo(request: RemoteChainInfoRequest): Promise<Result<RemoteChainInfoResponse, S.CallErrorValue<VersionedRemoteChainInfoError>>>",
  ...
  },
  {
    ...
    methods: [
      ...
      },
      {
        ...
        type: "subscription",
        signature:
          "listSubscribe(): ObservableLike<HostChatListSubscribeItem, S.CallErrorValue<VersionedHostChatListSubscribeError>>",
      ...
      },
      {
        ...
        type: "subscription",
        signature:
          "actionSubscribe(): ObservableLike<HostChatActionSubscribeItem, S.CallErrorValue<VersionedHostChatActionSubscribeError>>",
  ...
  },
  {
    ...
    methods: [
      ...
      },
      {
        ...
        type: "subscription",
        signature:
          "subscribe(request: HostLocalStorageSubscribeRequest): ObservableLike<HostLocalStorageChangeItem, S.CallErrorValue<VersionedHostLocalStorageSubscribeError>>",
    ...
    methods: [
      {
        ...
        type: "subscription",
        signature:
          "subscribe(): ObservableLike<HostLocaleSubscribeItem, S.CallErrorValue<VersionedHostLocaleSubscribeError>>",
    ...
    methods: [
      {
        ...
        type: "subscription",
        signature:
          "listSubscribe(): ObservableLike<HostPocketListSubscribeItem, S.CallErrorValue<VersionedHostPocketListSubscribeError>>",
      ...
      },
      {
        ...
        type: "unary",
        signature:
          "removeCard(request: HostPocketRemoveCardRequest): Promise<Result<undefined, S.CallErrorValue<VersionedHostPocketRemoveCardError>>>",
    ...
    methods: [
      {
        ...
        type: "subscription",
        signature:
          "lookupSubscribe(request: RemotePreimageLookupSubscribeRequest): ObservableLike<RemotePreimageLookupSubscribeItem, S.CallErrorValue<VersionedRemotePreimageLookupSubscribeError>>",
    ...
    methods: [
      {
        ...
        type: "subscription",
        signature:
          "render(request: ProductRendererRenderRequest): ObservableLike<RendererNode, S.CallErrorValue<VersionedProductRendererRenderError>>",
      ...
      },
      {
        ...
        type: "subscription",
        signature:
          "actionSubscribe(): ObservableLike<HostRendererActionSubscribeItem, S.CallErrorValue<VersionedHostRendererActionSubscribeError>>",
  ...
  },
  {
    ...
    methods: [
      ...
      },
      {
        ...
        type: "unary",
        signature:
          "signRawUnwatermarkedDeprecated(request: HostSignRawRequest): Promise<Result<HostSignPayloadResponse, S.CallErrorValue<VersionedHostSignRawError>>>",
        docUrl:
          "api/signing/trait.Signing.html#method.sign_raw_unwatermarked_deprecated",
        description:
      ...
      },
      {
        ...
        type: "unary",
        signature:
          "signRawUnwatermarkedDeprecatedWithLegacyAccount(request: HostSignRawWithLegacyAccountRequest): Promise<Result<HostSignPayloadResponse, S.CallErrorValue<VersionedHostSignRawWithLegacyAccountError>>>",
        docUrl:
          "api/signing/trait.Signing.html#method.sign_raw_unwatermarked_deprecated_with_legacy_account",
        description:
          "Sign the supplied data without adding or removing a watermark.\n\nTemporary compatibility API for runtime ownership proofs, including the\n32-byte Resources alias used by Humanity. Payload decoding matches\nwatermarked signing, but the decoded bytes are signed exactly as supplied.\nThis permits transaction-shaped data and requires signing authorization\nand explicit user confirmation.\n\n@deprecated Temporary unwatermarked signing; migrate to watermarked signing when the runtime supports it. This API will be removed. See https://github.com/paritytech/host-rust-core/issues/612",
        requestDescription: "HostSignRawWithLegacyAccountRequest",
        requestType: "host-sign-raw-with-legacy-account-request",
  ...
  },
  {
    ...
    methods: [
      ...
      },
      {
        ...
        type: "unary",
        signature:
          "info(): Promise<Result<HostInfo, S.CallErrorValue<VersionedHostInfoError>>>",
      ...
      },
      {
        ...
        type: "unary",
        signature:
          "getProductContext(): Promise<Result<HostGetProductContextResponse, S.CallErrorValue<VersionedHostGetProductContextError>>>",
    ...
    methods: [
      {
        ...
        type: "subscription",
        signature:
          "subscribe(): ObservableLike<HostThemeSubscribeItem, S.CallErrorValue<VersionedHostThemeSubscribeError>>",
    ...
    methods: [
      {
        ...
        type: "unary",
        signature:
          "beginOperation(request: HostWorkerBeginOperationRequest): Promise<Result<HostWorkerBeginOperationResponse, S.CallErrorValue<VersionedHostWorkerBeginOperationError>>>",
      ...
      },
      {
        ...
        type: "unary",
        signature:
          "endOperation(request: HostWorkerEndOperationRequest): Promise<Result<undefined, S.CallErrorValue<VersionedHostWorkerEndOperationError>>>",

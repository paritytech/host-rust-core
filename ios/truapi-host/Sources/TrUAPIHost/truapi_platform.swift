...
public struct SessionUiInfo: Equatable, Hashable {
     ...
     */
    public var deviceStatementAccountId: Bytes32?
    /**
    ...
    public init(
        ...
        self.deviceStatementAccountId = deviceStatementAccountId
...
public struct FfiConverterTypeSessionUiInfo: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> SessionUiInfo {
        return
            try SessionUiInfo(
                ...
                deviceStatementAccountId: FfiConverterOptionTypeBytes32.read(from: &buf),
    ...
    public static func write(_ value: SessionUiInfo, into buf: inout [UInt8]) {
        ...
        FfiConverterOptionTypeBytes32.write(value.deviceStatementAccountId, into: &buf)
...
public enum PermissionDecision: Equatable, Hashable {
...
#if compiler(>=6)
extension PermissionDecision: Sendable {}
#endif

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public struct FfiConverterTypePermissionDecision: FfiConverterRustBuffer {
    typealias SwiftType = PermissionDecision

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> PermissionDecision {
        let variant: Int32 = try readInt(&buf)
        switch variant {
    ...
    public static func write(_ value: PermissionDecision, into buf: inout [UInt8]) {
        switch value {
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypePermissionDecision_lift(_ buf: RustBuffer) throws -> PermissionDecision {
    return try FfiConverterTypePermissionDecision.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypePermissionDecision_lower(_ value: PermissionDecision) -> RustBuffer {
    return FfiConverterTypePermissionDecision.lower(value)
}

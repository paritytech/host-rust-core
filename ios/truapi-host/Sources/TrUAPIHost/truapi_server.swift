...
open func pairingPeerDisconnected(peer: NativePairingPeer)  {try! rustCall() {
    uniffi_truapi_server_fn_method_hostcallbacks_pairing_peer_disconnected(self.uniffiClonePointer(),
        FfiConverterTypeNativePairingPeer_lower(peer),$0
    )
}
}
...
open func disconnectPairing(peer: NativePairingPeer)throws   {try rustCallWithError(FfiConverterTypeNativePairingError_lift) {
    uniffi_truapi_server_fn_method_nativetruapicore_disconnect_pairing(self.uniffiClonePointer(),
        FfiConverterTypeNativePairingPeer_lower(peer),$0
    )
}
}
...
open func respondToPairing(deeplink: String)throws  -> NativePairingPeer  {
    ...
    uniffi_truapi_server_fn_method_nativetruapicore_respond_to_pairing(self.uniffiClonePointer(),
        FfiConverterString.lower(deeplink),$0
    )
})
}
...
open func resumePairing(peer: NativePairingPeer)throws   {try rustCallWithError(FfiConverterTypeNativePairingError_lift) {
    uniffi_truapi_server_fn_method_nativetruapicore_resume_pairing(self.uniffiClonePointer(),
        FfiConverterTypeNativePairingPeer_lower(peer),$0
    )
}
}
...
open func suspendAllPairings()  {try! rustCall() {
    uniffi_truapi_server_fn_method_nativetruapicore_suspend_all_pairings(self.uniffiClonePointer(),$0
    )
}
}
...
open func suspendPairing(peer: NativePairingPeer)throws   {try rustCallWithError(FfiConverterTypeNativePairingError_lift) {
    uniffi_truapi_server_fn_method_nativetruapicore_suspend_pairing(self.uniffiClonePointer(),
        FfiConverterTypeNativePairingPeer_lower(peer),$0
    )
}
}
 ...
 */
public struct NativePairingPeer {
    /**
...
extension NativePairingPeer: Equatable, Hashable {
    public static func ==(lhs: NativePairingPeer, rhs: NativePairingPeer) -> Bool {
        if lhs.statementAccountId != rhs.statementAccountId {
            return false
        }
    ...
    public func hash(into hasher: inout Hasher) {
        hasher.combine(statementAccountId)
 ...
 */
public enum NativePairingError: Swift.Error {
...
extension NativePairingError: Equatable, Hashable {}




extension NativePairingError: Foundation.LocalizedError {
    public var errorDescription: String? {
        String(reflecting: self)
    }
}
...
private let initializationResult: InitializationResult = {
    ...
    if (uniffi_truapi_server_checksum_method_hostcallbacks_pairing_peer_disconnected() != 14500) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_truapi_server_checksum_method_hostcallbacks_core_storage_read() != 37995) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_truapi_server_checksum_method_hostcallbacks_core_storage_write() != 29818) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_truapi_server_checksum_method_hostcallbacks_core_storage_clear() != 2088) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_truapi_server_checksum_method_hostcallbacks_chain_connect() != 20139) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_truapi_server_checksum_method_hostcallbacks_chain_send() != 20316) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_truapi_server_checksum_method_hostcallbacks_chain_close() != 8876) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_truapi_server_checksum_method_hostcallbacks_confirm_user_action() != 7212) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_truapi_server_checksum_method_hostcallbacks_lookup_preimage() != 52375) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_truapi_server_checksum_method_hostcallbacks_current_theme() != 61535) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_truapi_server_checksum_method_hostcallbacks_feature_supported() != 37869) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_truapi_server_checksum_method_hostcallbacks_local_storage_read() != 8713) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_truapi_server_checksum_method_hostcallbacks_local_storage_write() != 35971) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_truapi_server_checksum_method_hostcallbacks_local_storage_clear() != 3548) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_truapi_server_checksum_method_nativetruapicore_disconnect_pairing() != 55406) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_truapi_server_checksum_method_nativetruapicore_respond_to_pairing() != 50066) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_truapi_server_checksum_method_nativetruapicore_resume_pairing() != 52006) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_truapi_server_checksum_method_nativetruapicore_suspend_all_pairings() != 35532) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_truapi_server_checksum_method_nativetruapicore_suspend_pairing() != 53776) {
        return InitializationResult.apiChecksumMismatch
    }

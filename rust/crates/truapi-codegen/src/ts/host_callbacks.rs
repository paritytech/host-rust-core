...
fn emit_host_callbacks(
    ...
    writedoc!(
        ...
        //
        // Typed host-callbacks surface derived from the `platform` modules'
...
/// All names defined locally in the `platform` modules: capability trait names plus

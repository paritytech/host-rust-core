...
/// Wire discriminants for `chat_custom_message_render_channel`.
pub const CHAT_CUSTOM_MESSAGE_RENDER_CHANNEL: SubscriptionFrameIds = SubscriptionFrameIds {
    start_id: 52,
    stop_id: 53,
    interrupt_id: 54,
    receive_id: 55,
...
pub const WIRE_TABLE: &[WireEntry] = &[
    ...
    WireEntry {
        method: "chat_custom_message_render_channel",

...
pub mod latest {
    ...
    pub use crate::v01::{
        ...
        HostPeerTransportCloseError, HostPeerTransportCloseRequest, HostPeerTransportDialError,
        HostPeerTransportDialRequest, HostPeerTransportDialResponse, HostPeerTransportEventsError,
        HostPeerTransportEventsResponse, HostPeerTransportOpenError, HostPeerTransportOpenRequest,
        HostPeerTransportOpenResponse, HostPeerTransportRecvError, HostPeerTransportRecvRequest,
        HostPeerTransportRecvResponse, HostPeerTransportResetError, HostPeerTransportResetRequest,
        HostPeerTransportSendError, HostPeerTransportSendRequest, HostPlatform,
        HostSignPayloadData, HostWorkerOperationError, ImageFit, ImageProps, ImageSource, Modifier,
        NotificationId, OperationId, OperationStartedResult,
        PEER_TRANSPORT_MAX_BUFFERED_BYTES_PER_CONNECTION, PEER_TRANSPORT_MAX_CONNECTIONS,
        PEER_TRANSPORT_MAX_MESSAGE_BYTES, PEER_TRANSPORT_MAX_STREAMS_PER_CONNECTION,
        PeerTransportEvent, PocketCard, ProductAccountId, ProductProofContext, RawPayload,

...
//! and each variant wraps either [`Request`] or [`Subscription`] rather than a
//! bare payload: version selects a method's shape, direction is carried inside
//! that version's payload rather than addressed by a separate wire id.

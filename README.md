...
On every platform the bridge also rebinds the port itself when its listener starts failing,
pausing between attempts instead of retrying in a tight loop.
